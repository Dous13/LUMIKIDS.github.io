...
} from "../../services/database/localWriting";
...
export default function ReadingScreen() {
  ...
  if (!session) return;
    ...
    const data = getAllWritingProgress(
    session.studentId
    );
  ...
  writingLessons.length > 0
    ? (completedLessons / writingLessons.length) * 100
    : 0;
      ...
      <View style={styles.heroCard}>
        ...
        <View style={styles.progressCard}>
          ...
          <Text style={styles.progressText}>
            {completedLessons} of {writingLessons.length} Letters Completed
          </Text>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                navigation.navigate("WritingLesson", {
                    lessonId: item.id,
                })
              }
            >
